...
//products list
const { evaluations } = defineProps({
    evaluations: Object,
});

const confirmingDocDeletion = ref(false);
const docToDelete = ref(null);
const dataToRender = ref(evaluations);
                    ...
                    <tbody>
                        ...
                        <td v-if="$page.props.auth.user.role === 'admin'"
                            ...
                            >
                                ...
                                >
                                    <p class="font-black">Resultado:</p>
                                    <p class="ml-1">
                                        {{ item.interpretation[1].sum }}
                                    </p>
                                </div>
                                <div
                                    :class="{
                                    ...
                                    class="flex flex-col justify-center items-start p-4 rounded-lg border-2 shadow-md mt-2"
                                >
                                    <div
                                        class="flex flex-row justify-center items-center"
                                    >
                                    ...
                                    >
                                        <p class="font-black">Percentil:</p>
                                        <p class="ml-1">
                                            {{
                                                item.interpretation[1].percentil
                                            }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p class="ml-1">
                                            {{
                                                item.interpretation[2].percentil
                                            }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p class="ml-1">
                                            {{
                                                item.interpretation[3].percentil
                                            }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                ...
                                >
                                    <p class="font-black">Resultado:</p>
                                    <p class="ml-1">
                                        {{ item.interpretation[4].sum }}
                                    </p>
                                </div>
                                <div
                                    :class="{
                                        'bg-green-200 text-green-800 border-green-300':
                                            item.interpretation[4]
                                                .interpretation === 'Excelente',
                                        'bg-blue-200 text-blue-800 border-blue-300':
                                            item.interpretation[4]
                                                .interpretation === 'Muy bueno',
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p class="ml-1">
                                            {{
                                                item.interpretation[4].percentil
                                            }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            >
                                <div class="flex gap-2 items-center">
                                    ...
                                    <a
                                        :href="
                                            route('evaluations.export.excel', {
                                                evaluation_id: item.id,
                                            })
                                        "
                                        class="flex justify-center"
